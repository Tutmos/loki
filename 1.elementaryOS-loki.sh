...
sudo apt -y install rar unrar cabextract lzip lunzip arj unace p7zip-rar p7zip
...
#sudo useradd -g everyone vesel
#sudo chown -R vesel:everyone ./Library/
#sudo chmod -R 775 ./Library/

...
gsettings set org.pantheon.desktop.cerbere monitored-processes "['wingpanel', 'plank', 'slingshot-launcher --silent', 'nautilus -n']"
...
sudo rm /usr/share/applications/org.pantheon.files.desktop
killall nautilus
